...
# LongitudinalData: print, Subject
# Subject: print, summary, visit
# Visit: room
# Room: print, summary
# Summary: print
...
# make_LD = helper function that converts a data frame into a Longitudinal Data object
# subject = generic function for extracting subject-specific information
# visit = generic function for extracting visit-specific information
# room = generic function for extracting room-specific information
